...
age_hist <- ggplot(aes(age), data = households)
...
ggplot(aes(income.hh.av.rent), data = houseinc) +
  ...
  scale_x_continuous(tran="log1p",
                     breaks=c(3, 420, 576, 739, 908, 1110, 1370, 1710, 2310,
                              3610, 53300)) +
  xlab("Household Monthly Income (US$)") +
  ylab("Density") +
...
ggplot(aes(income.hh.av.rent), data = houseinc) +
  ...
  scale_x_continuous(breaks=c(3, 420, 576, 739, 908, 1110, 1370, 1710, 2310,
                              3610), limits = c(0,3610)) +
  xlab("Household Monthly Income (US$)") +
  ylab("Frequency") +
  theme(axis.text.x = element_text(angle = 90, hjust = 1))
```
...
US$`r summary(houseinc$income.hh.av.rent)[3]`. How it does compare with other 
countries?
...
ggplot(aes(Var2, y = 100 * Freq), data = cont_table) + 
  ...
  scale_fill_brewer(palette = "Paired") +
  geom_text(
    aes(label = paste(format(100 * Freq, digits = 1), "%"), y = 100 * pos),
    size = 4.) + 
...
```{r warning = F, echo = F, fig.align = 'center'}
p1 <- ggplot(aes(income.hh.av, income.hh.av - expenses.tot),
             data = subset(households, household.head == 1)) +
  geom_point(alpha = 0.3) + scale_x_log10(breaks = c(100, 1000, 10000)) + 
  geom_smooth() +
  coord_cartesian()

p2 <- ggplot(aes(income.hh.av, income.hh.av - expenses.tot), 
             data = subset(households, household.head == 1)) +
  geom_point(alpha = 0.3) + scale_x_log10(breaks = c(100, 1000, 10000)) + 
  geom_smooth() +
...
ggplot(aes(income.dec, expenses.tot / income.hh.av),
       data = subset(households,
                     person.id == 1 & expenses.tot / income.hh.av <= 10)) + 
